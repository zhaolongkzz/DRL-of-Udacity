...
'''
Here is the Double dqn and with Prioritized Experience Replay
'''
...
class Agent():
    ...
    def learn(self, experiences, gamma):
        ...
        double_Q_targets_next = self.qnetwork_target(next_states).detach().max(1)[0].unsqueeze(1)
        ...
        Q_target_next =  self.qnetwork_local(states).gather(1, best_actions).detach()
